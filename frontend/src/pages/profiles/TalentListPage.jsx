...
const TalentListPage = () => {
    ...
    useEffect(() => {
        const fetchTalents = async () => {
            try {
                setLoading(true);
                const data = await profilesService.getProfiles({ search: searchTerm });
                ...
                {loading ? (
                    ...
                    filteredTalents.map(talent => (
                        <div
                            ...
                            className="premium-card p-8 flex flex-col items-center text-center group cursor-pointer hover:border-primary-500 transition-all duration-300"
                        >
