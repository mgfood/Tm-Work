...
const TalentProfilePage = () => {
    ...
    if (error || !profile) return (
        <div className="max-w-4xl mx-auto px-6 py-20 text-center" data-testid="profile">
    ...
    return (
        <div className="max-w-5xl mx-auto px-6 py-12" data-testid="profile">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="lg:col-span-2 space-y-12">
                    ...
                    <section>
                        ...
                        <p className="text-xl text-slate-700 leading-relaxed font-medium" data-testid="bio">
