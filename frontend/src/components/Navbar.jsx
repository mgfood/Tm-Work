...
const Navbar = () => {
    ...
    const { user, logout, loading, currentRole } = useAuth();
                        ...
                        {loading ? (
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <Link
                                    ...
                                    className="w-8 h-8 bg-primary-50 text-primary-600 rounded-full flex items-center justify-center font-bold border-2 border-primary-100"
                                >
