...
const Footer = () => {
    ...
    return (
        <footer className="bg-slate-900 text-slate-400 py-16 px-6 pb-24 md:pb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><Link to="/terms" className="hover:text-white transition-colors">{t('footer.rules')}</Link></li>
